...
public class IssueIndexerTest {
  ...
  public void verify_indexed_fields() {
    ...
    assertThat(doc.gap()).isEqualTo(issue.getGap());
    ...
    assertThat(doc.message()).isEqualTo(issue.getMessage());
    // functional date
